...
export const bugReports = pgTable(
  "bug_reports",
  {
    ...
    feedbackFeature: text("feedback_feature"),
    feedbackUserStory: text("feedback_user_story"),
    feedbackLocation: text("feedback_location"),
    feedbackCurrentSpec: text("feedback_current_spec"),
    feedbackIntendedSpec: text("feedback_intended_spec"),
    feedbackReportedAt: timestamp("feedback_reported_at", { withTimezone: true }),
    feedbackReporter: text("feedback_reporter"),
